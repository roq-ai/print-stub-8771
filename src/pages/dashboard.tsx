...
import { getReceipts } from 'apiSdk/receipts';
...
function DashboardPage() {
  ...
  const receiptStat = useSWR<PaginatedInterface<ReceiptInterface>>(
    () => `/receipts`,
    () => getReceipts({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Receipts',
      result: receiptStat?.data?.totalCount,
      isLoading: receiptStat.isLoading,
    },
    {
      title: 'Products',
