...
export function StoreListPage(props: StoreListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStores({
        relations: ['business', 'product.count', 'receipt.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('receipt', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'receipt',
          header: 'Receipt',
          accessorKey: 'receipt',
          cell: ({ row: { original: record } }: any) => record?._count?.receipt,
        }
      : null,
