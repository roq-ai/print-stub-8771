...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Print stub`}</title>

        <meta
          name="description"
          content="Experience seamless and efficient receipt management with Print Stub - Your ultimate solution for printing receipts from tablets, iPads, and mobiles."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1545941962-1b6654eb8072?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWNlaXB0fGVufDB8fHx8MTY5MTk5MzE3OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ml1989?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Michael Walter`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless and efficient receipt management with Print Stub - Your ultimate solution for printing receipts from tablets, iPads, and mobiles.`}
            </Text>
            <Box
