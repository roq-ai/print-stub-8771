...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'store-manager', 'sales-associate', 'it-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Receipts', path: '/receipts', entity: 'receipt', service: AccessServiceEnum.PROJECT, icon: FiFileText },
